DESCRIPTION = "Memory Manager Kernel module for Renesas RZV2N"
...
SRC_URI:append = " \
    ...
    file://0003-Do-not-parse-and-init-lossy-mem-area-for-RZ-V2N.patch \
    file://0004-Add-MM_OMXBUF_SIZE-for-RZ-V2N-OMX.patch \
