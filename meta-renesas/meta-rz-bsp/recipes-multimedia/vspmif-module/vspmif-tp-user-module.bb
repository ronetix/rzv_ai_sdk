DESCRIPTION = "VSP Manager Interface test app for RZV2N"
...
"
FILES:${PN} = " \
    ${@oe.utils.conditional('WS', '32', '${RENESAS_DATADIR}/bin/vspm_tp32 ${RENESAS_DATADIR}/bin/isum_tp32', \
    '${RENESAS_DATADIR}/bin/vspm_tp ${RENESAS_DATADIR}/bin/isum_tp', d)}"
